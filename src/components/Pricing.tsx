...
import { Box, Flex ,Button ,Text,Heading, HStack, StackProps,  Icon, Stack } from '@chakra-ui/react';
...
export const ListItem =(props:StackProps) =>{
    ...
    return(
        <HStack as='li' spacing='22px'{...rest} alignItems='start'>
    ...
    return (
        ...
        <Flex direction={['column','column','row']}>
            <Box bg='#F0EAFB' p='60px'>
                <Text color=' #171923'fontSize='24px' fontWeight='800'>Premium PRO</Text>
